...
# put our game rules in a dict since theres a few
# these are outcomes which result in the user winning
# if the user doesn't win according to our rules then the computer does
rules = {
    ("rock", "scissors"): "user",
    ("rock", "lizard"): "user",
    ("paper", "rock"): "user",
...
def get_computer_choice():
    # randomly choose between rock, paper, scissors, lizard, and spock
    choices = ['rock', 'paper', 'scissors', 'lizard', 'spock']
    return random.choice(choices)

def get_user_choice():
    # get the users choice and validate input
    user_input = input(f"{rpsU} Enter your choice (rock, paper, scissors, lizard, spock): ").strip().lower()
    while user_input not in ['rock', 'paper', 'scissors', 'lizard', 'spock']:
...
def determine_winner(user_choice, computer_choice):
    ...
    if user_choice == computer_choice:
        ...
        return rules[(user_choice, computer_choice)]
    else:
        return "computer"

def play_round():
    # start a round of rpsls
